...
Date: July 20, 2023
Description: A test program for executing queries in the pysports database
"""
...
try:
    """ try/catch block handling potential MySQL database errors"""
    ...
    # get the results for cursor object
